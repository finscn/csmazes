...
Maze.createWidget = function (algorithm, width, height, options) {
  ...
  if ((ref = options.watch) != null ? ref : true) {
    watch =
      "<a id='" +
      id +
      "_watch' href='#' onclick='document.getElementById(\"" +
      id +
  ...
  html =
    ...
    id +
    '_reset" href="#" onclick="document.getElementById(\'' +
    id +
    '\').mazeReset(); return false;">Reset</a>\n    <a id="' +
    id +
    '_step" href="#" onclick="document.getElementById(\'' +
    id +
    "').mazeStep(); return false;\">Step</a>\n    " +
    watch +
    '\n    <a id="' +
    id +
    '_run" href="#" onclick="document.getElementById(\'' +
    id +
  ...
  element.mazeRun = function () {
    if (!this.mazePause()) {
      return (this.mazeStepInterval = setInterval(
        (function (_this) {
          return function () {
  ...
  element.mazeStep = function () {
    ...
    if (!this.maze.step()) {
      ...
      if ((ref1 = options.watch) != null ? ref1 : true) {
        this.addClassName(
          document.getElementById(this.id + "_watch"),
          "disabled"
        );
      }
      return this.addClassName(
        document.getElementById(this.id + "_run"),
        "disabled"
      );
    }
  };
  ...
  element.mazeReset = function () {
    ...
    grid = "";
    for (
      y = i = 0, ref1 = this.maze.height;
      0 <= ref1 ? i < ref1 : i > ref1;
      y = 0 <= ref1 ? ++i : --i
    ) {
      row_id = this.id + "_y" + y;
      grid += "<div class='row' id='" + row_id + "'>";
      for (
        x = j = 0, ref2 = this.maze.width;
    ...
    this.removeClassName(
      document.getElementById(this.id + "_step"),
      "disabled"
    );
...
Maze.createCanvasWidget = function (algorithm, width, height, options) {
  ...
  COLORS = {
    ...
    ParallelBacktracker: function (maze, x, y) {
      ...
      if (maze.algorithm.isStack(x, y)) {
        return (ref1 = styles.sets["stack-" + cell.set]) != null
          ? ref1
          : styles.f;
      } else if (!maze.isBlank(x, y)) {
  ...
  html =
    ...
    '">\n  <canvas id="' +
    id +
    '_canvas" width="420" height="420" class="' +
    gridClass +
    '"></canvas>\n  <div class="operations">\n    <a id="' +
    id +
    '_reset" href="#" onclick="document.getElementById(\'' +
